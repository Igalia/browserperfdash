...
urlpatterns = [
    ...
    url(r'^report/improvement/(?P<days_since>\d+)/(?P<platform>\w+)/(?P<gpu>\w+)/(?P<cpu>\w+)/$', BotDataReportImprovementListView.as_view()),
    url(r'^report/improvement/(?P<days_since>\d+)/(?P<platform>\w+)/(?P<gpu>\w+)/(?P<cpu>\w+)/$', BotDataReportImprovementListView.as_view()),
    ...
    url(r'^report/regression/(?P<days_since>\d+)/(?P<platform>\w+)/(?P<gpu>\w+)/$', BotDataReportRegressionListView.as_view()),
    url(r'^report/regression/(?P<days_since>\d+)/(?P<platform>\w+)/(?P<gpu>\w+)/(?P<cpu>\w+)/$', BotDataReportRegressionListView.as_view()),
    url(r'^report/regression/(?P<days_since>\d+)/(?P<platform>\w+)/(?P<gpu>\w+)/(?P<cpu>\w+)/$', BotDataReportRegressionListView.as_view()),
